...
// // If a token is null, it was not added to everest and we want to ignore it
...
//         token.name = data.get('name').isNull() ? null : data.get('name').toString()
//         token.description = data.get('description').isNull()
//           ? null
//           : data.get('description').toString()
//         token.website = data.get('website').isNull()
//           ? null
//           : data.get('website').toString()
//         token.twitter = data.get('twitter').isNull()
//           ? null
//           : data.get('twitter').toString()
//         token.github = data.get('github').isNull()
//           ? null
//           : data.get('github').toString()
//         token.avatar = data.get('avatar').isNull()
//           ? null
//           : data.get('avatar').toString()
//         token.image = data.get('image').isNull() ? null : data.get('image').toString()
//         // token.isRepresentative = data.get('isRepresentative').isNull()
//         //   ? null
